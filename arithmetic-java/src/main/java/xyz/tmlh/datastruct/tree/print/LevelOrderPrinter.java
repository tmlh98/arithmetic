package xyz.tmlh.datastruct.tree.print;
...
public class LevelOrderPrinter extends Printer {
	...
	private void fillNodes() {
		// 第一行
		List<Node> firstRowNodes = new ArrayList<Node>();
	...
	private void addLineNodes() {
		List<List<Node>> newNodes = new ArrayList<List<Node>>();
		...
		for (int i = 0; i < rowCount; i++) {
			...
			List<Node> newRowNodes = new ArrayList<Node>();
